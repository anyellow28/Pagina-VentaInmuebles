<?php
include './LibreriaVentaDepartamento.php';
$cant=0;
$icom=0.0;
$ides=0.0;
$ipag=0.0;
...
<html>
	...
	<div class="panel panel-default">
	    		<div class="panel-heading"><h3>VENTA DEL DEPARTAMENTO</h3></div>
				<div class="panel-body">
				
	<form name="frmVista" method="post" action="Departamento.php" class="form-horizontal" >
	    <hr />
            <div class="form-group">
                <label for="frmBoleta:txtCant" class="control-label col-sm-4">Metros Cuadrados:</label>
                <div class="col-sm-2">
             ...
             <div class="form-group">
                <label for="frmBoleta:txthab" class="control-label col-sm-4">Nro Habitaciones:</label>
                <div class="col-sm-2">
                    <input type="number" name="txthab" 
                     class="form-control" required placeholder="Habitaciones" />
                </div>
            </div>
            <br>
            <div class="form-group">
                <label for="frmBoleta:cboModelo" class="control-label col-sm-4">Distrito:</label>
                <div class="col-sm-3">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="number" name="txthab" 
                     class="form-control" disabled value="<?php echo $hab ?>" />
                </div>
            </div>
            <br>
            <div class="form-group">
            ...
            <br>
            <div class="form-group">
                <label for="frmBoleta:txtObse" class="control-label col-sm-4">Articulos para el hogar:</label>
                <div class="col-sm-2">
                    <input type="number" name="txtObse" 
                     class="form-control" disabled value="<?php echo $regalo ?>" />
                </div>
            </div> 
    </form>
      </div>
